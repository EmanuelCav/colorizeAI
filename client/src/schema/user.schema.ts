...
export const registerSchema = object().shape({
    username: string().trim().min(1, 'Username field is empty. Please complete').matches(/^[A-Za-z0-9ñÑáéíóúÁÉÍÓÚüÜ]+$/, {
        message: "Only numbers and letters, characters are allowed"
